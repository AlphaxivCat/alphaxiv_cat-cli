...
var organizationsV2ListTop = cli.Command{
	Name:            "list-top",
	Usage:           "Retrieve the top 20 organizations with images by paper count",
	Suggest:         true,
	Flags:           []cli.Flag{},
	Action:          handleOrganizationsV2ListTop,
	HideHelpCommand: true,
}

var organizationsV2RetrieveByID = cli.Command{
	Name:    "retrieve-by-id",
	Usage:   "Retrieve an organization's basic information given its ID.",
	Suggest: true,
	Flags: []cli.Flag{
...
var organizationsV2RetrieveByName = cli.Command{
	Name:    "retrieve-by-name",
	Usage:   "Retrieve an organization's basic information given it's name – casing does not\nmatter (i.e. google and GOOGLE return the same results).",
	Suggest: true,
	Flags: []cli.Flag{
		&requestflag.Flag[string]{
			Name:     "name",
...
var organizationsV2Search = cli.Command{
	Name:    "search",
	Usage:   "Search organizations by name",
	Suggest: true,
	Flags: []cli.Flag{
		&requestflag.Flag[string]{
			Name:      "q",
	...
	Action:          handleOrganizationsV2Search,
	HideHelpCommand: true,
}

var organizationsV2ToggleFollow = cli.Command{
	Name:    "toggle-follow",
	Usage:   "Toggle following an organization, affects the current user's profile",
	Suggest: true,
	Flags: []cli.Flag{
		&requestflag.Flag[string]{
			Name:     "id",
...
func handleOrganizationsV2ListTop(ctx context.Context, cmd *cli.Command) error {
	...
	_, err = client.Organizations.V2.ListTop(ctx, options...)
	if err != nil {
		return err
	}
...
func handleOrganizationsV2RetrieveByID(ctx context.Context, cmd *cli.Command) error {
	...
	var res []byte
	options = append(options, option.WithResponseBodyInto(&res))
	_, err = client.Organizations.V2.GetByID(ctx, cmd.Value("id").(string), options...)
	if err != nil {
		return err
	}
...
func handleOrganizationsV2RetrieveByName(ctx context.Context, cmd *cli.Command) error {
	...
	var res []byte
	options = append(options, option.WithResponseBodyInto(&res))
	_, err = client.Organizations.V2.GetByName(ctx, cmd.Value("name").(string), options...)
	if err != nil {
		return err
	}
...
func handleOrganizationsV2Search(ctx context.Context, cmd *cli.Command) error {
	...
	var res []byte
	options = append(options, option.WithResponseBodyInto(&res))
	_, err = client.Organizations.V2.Search(ctx, params, options...)
	if err != nil {
		return err
	}
...
func handleOrganizationsV2ToggleFollow(ctx context.Context, cmd *cli.Command) error {
	...
	var res []byte
	options = append(options, option.WithResponseBodyInto(&res))
	_, err = client.Organizations.V2.ToggleFollow(ctx, cmd.Value("id").(string), options...)
	if err != nil {
		return err
	}
